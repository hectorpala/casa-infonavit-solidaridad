                    ...
                    CustomMarker.prototype.onAdd = function() {
                        ...
                        div.addEventListener('click', () => {
                            const infoWindow = new google.maps.InfoWindow({
                                content: \`
                                    <div style="font-family: 'Poppins', sans-serif; padding: 0; max-width: 280px;">
                                        ...
                                        <div style="padding: 12px;">
                                            <h4 style="margin: 0 0 8px 0; color: #FF6B35; font-size: 15px; font-weight: 600;">\${MARKER_CONFIG.priceShort}</h4>
                                            <h5 style="margin: 0 0 6px 0; color: #1f2937; font-size: 13px; font-weight: 600;">\${MARKER_CONFIG.title}</h5>
                                            <p style="margin: 0; color: #6b7280; font-size: 12px; line-height: 1.4;">\${MARKER_CONFIG.location}</p>
                                        </div>
                                    </div>
                                \`
                            });
