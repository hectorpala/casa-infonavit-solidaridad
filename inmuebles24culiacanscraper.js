...
function normalizeLocationForCity(rawLocation, cityName, stateName) {
    ...
    // DISPLAY COMPLETO: usar la ubicación completa en vez de solo primary
    // Esto se mostrará arriba del mapa como dirección completa
    const display = location; // Dirección completa detectada
