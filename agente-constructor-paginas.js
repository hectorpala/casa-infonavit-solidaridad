...
${caracteristicasHTML}
    ...
    generarTarjetaAvanzada(datos) {
        const fotosCarrusel = datos.fotos.slice(0, 6).map(foto => 
            `<div class="slide"><img src="${foto.ruta}" width="1200" height="800" decoding="async" loading="lazy" alt="${foto.alt}"></div>`).join('\n                            ');
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow property-card relative" 
            ...
            <div class="relative aspect-video">
                ...
                <div class="carousel" data-count="${Math.min(datos.fotos.length, 6)}">
                    <button class="arrow prev" aria-label="Anterior">‹</button>
            ...
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-4 font-poppins">${datos.nombre} · ${datos.ubicacion}</p>
