/**
 * Script para descargar y procesar vialidades de INEGI para García
 * Fuente: API INEGI - Catálogo de Vialidades
 * URL: https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/19/018
 *
...
console.log('📥 Descargando vialidades de INEGI para García...');
console.log('🌐 API: https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/19/018');

https.get('https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/19/018', (res) => {
    let data = '';
    ...
    res.on('end', () => {
        ...
        const outputPath = 'calles-inegi-garcia.json';
