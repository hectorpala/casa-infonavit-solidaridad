/**
 * Script para descargar y procesar vialidades de INEGI para Mazatlán
 * Fuente: API INEGI - Catálogo de Vialidades
 * URL: https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/25/012
 *
 * Código Geo: 25/012 (25=Sinaloa, 012=Mazatlán)
 */

const fs = require('fs');
const https = require('https');

console.log('📥 Descargando vialidades de INEGI para Mazatlán...');
console.log('🌐 API: https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/25/012');

https.get('https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/25/012', (res) => {
    let data = '';
    ...
    res.on('end', () => {
        ...
        const outputPath = 'calles-mazatlan-completo.json';
        ...
        const outputPathDetailed = 'calles-mazatlan-detallado.json';
