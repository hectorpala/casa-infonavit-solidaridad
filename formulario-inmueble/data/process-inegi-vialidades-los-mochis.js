/**
 * Script para descargar y procesar vialidades de INEGI para Los Mochis
 * Fuente: API INEGI - Catálogo de Vialidades
 * URL: https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/25/011
 *
...
console.log('📥 Descargando vialidades de INEGI para Los Mochis...');
console.log('🌐 API: https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/25/011');
...
https.get('https://gaia.inegi.org.mx/wscatgeo/v2/vialidades/25/011', (res) => {
    ...
    res.on('end', () => {
        ...
        const outputPath = 'calles-los-mochis.json';
