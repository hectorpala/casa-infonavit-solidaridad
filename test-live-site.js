...
(async () => {
    console.log('🔍 Probando botón Ver mapa en PRODUCCIÓN...\n');
    console.log('⏰ Esperando 90 segundos para que GitHub Pages despliegue...\n');
    ...
    console.log('📄 Cargando página en producción...');
    ...
    console.log('\n⏸️  Navegador abierto por 10 segundos (verifica manualmente)...\n');
