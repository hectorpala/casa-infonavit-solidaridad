...
// Cargar direcciones
const addressesFile = path.join(__dirname, 'remaining-addresses.json');
...
function geocodeNext() {
    if (index >= addresses.length) {
        ...
        // Guardar resultados
        const outputFile = path.join(__dirname, 'geocoded-coordinates-remaining.json');
        fs.writeFileSync(outputFile, JSON.stringify(results, null, 2), 'utf8');

        console.log(`💾 Coordenadas guardadas en: geocoded-coordinates-remaining.json\n`);
